...
public class CreatePrefilledForm_2 extends PlexusSharedFunctions {
  @Test
  public void CreatePreFilledForm() throws InterruptedException {
	  ...
	  PlexusSharedFunctions.CreatePrefilledFormCheck(".//*[@id='root']/div/div[2]/div[2]/div/div/div[1]/div/ul[1]/li[2]/div/ul/li[2]/a/span[1]");
  ...
  public void HowtoEnter() throws InterruptedException
  {
	  ...
	  PlexusSharedFunctions.verifyTextPresent("How to Enter");
	  PlexusSharedFunctions.verifyTextPresent("What social media platform?");
	  PlexusSharedFunctions.CheckifDropdownisSelected("platform", "Facebook");
      ...
      driver.findElement(By.name("socialUrl")).sendKeys("www.promotion.com");
      PlexusSharedFunctions.CheckifElementsSelected(".//*[@id='entry-step-form']/main/section/div[4]/div[1]/div[1]/div/div/div/div/label/div/div[2]");
      driver.findElement(By.name("tags__tag__0")).sendKeys("#promotionname");
      PlexusSharedFunctions.CheckifElementsSelected(".//*[@id='entry-step-form']/main/section/div[5]/div[1]/div[2]/div/div[1]/div/div/div/label/div/div[2]");
      Thread.sleep(2000);
      PlexusSharedFunctions.CheckInputinTextArea("//*[@id='entry-step-form']/main/section/div[5]/div[1]/div[2]/div/div[3]/div/span[1]/input", "the promotion post describing TOPIC in 25 words or less");
	  PlexusSharedFunctions.ClickablebyXpath(".//*[@id='entry-step-form']/footer/button[2]");
	  Thread.sleep(2000);
	  PlexusSharedFunctions.CheckInputinTextArea("//*[@id='winning-method-form']/main/div[6]/div/span[1]/input", "Judging");
	  PlexusSharedFunctions.CheckifDropdownisSelected("judges", "Representatives of the Promoter");
	  PlexusSharedFunctions.CheckifDropdownisSelected("criteria", "Creative Merit");
