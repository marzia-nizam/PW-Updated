...
public class RegTest_14 extends PlexusSharedFunctions{
  @Test
  public void RegTest14() throws InterruptedException {
	  PlexusSharedFunctions.Login();
	  PlexusSharedFunctions.ImplicitWait(30);
	  PlexusSharedFunctions.CheckPromotionForm(Name+"RegTest14");
  ...
  public void HowtoEnter() throws InterruptedException
  {
	  ...
	  Thread.sleep(4000);
	  PlexusSharedFunctions.ScrollDownintoView(".//*[@id='root']/div/div[2]/div[2]/div/div/div/button");
	  PlexusSharedFunctions.ClickablebyXpath(".//*[@id='root']/div/div[2]/div[2]/div/div/div/button");
	  PlexusSharedFunctions.ClickablebyXpath(".//*[@id='entry-method-form']/main/div[4]/div[1]/div[2]/div/div/div/div/label/div/div[2]");
	  PlexusSharedFunctions.ClickablebyXpath(".//*[@id='entry-method-form']/footer/button");
	 // PlexusSharedFunctions.ClickablebyXpath("//span[contains(text(),'Add 1st Step')]");
	  PlexusSharedFunctions.ClickablebyXpath(".//*[@id='entry-step-form']/main/div[2]/div[1]/div[1]/div/div/div/label/div[2]/span");
	  PlexusSharedFunctions.ClickablebyXpath(".//*[@id='entry-step-form']/main/section/div[1]/div[1]/div[1]/div/div/div/div/label/div[1]/div[2]");
	  Select oSelect7 = new Select(driver.findElement(By.name("purchaseRequirement")));
	  oSelect7.selectByVisibleText("Buy a certain number of these products or services");
	  driver.findElement(By.name("products__name__0")).sendKeys("Samsung Galaxy Phone");
	  Select oSelect4 = new Select(driver.findElement(By.name("purchaseTransactionType")));
	  oSelect4.selectByVisibleText("One transaction");
	  Select oSelect5 = new Select(driver.findElement(By.name("purchaseLocations")));
	  oSelect5.selectByVisibleText("Any stores displaying promotional material (including online)");
	  Select oSelect6 = new Select(driver.findElement(By.name("purchaseAlcohol")));
	  oSelect6.selectByVisibleText("No, it does not involve the purchase of alcohol");
	  PlexusSharedFunctions.ClickablebyXpath(".//*[@id='entry-step-form']/footer/button[2]");
   ...
   //   driver.findElement(By.linkText("Last")).click();
	  ...
	  PlexusSharedFunctions.ClickablebyXpath(".//*[@id='winning-method-form']/main/div[4]/div/div[1]/div/div/div/label/div[2]/span");
  	...
  	boolean element=driver.findElement(By.xpath("//span[contains(text(),'The draw date has to be on or after the earliest entry date ("+start_date+" 09:00 am).')]")).isDisplayed();
	    ...
	    PlexusSharedFunctions.ClickablebyXpath("//h2[text()='How to Enter']//following::div[@class='icon'][2]");
        ...
        Thread.sleep(4000);
        PlexusSharedFunctions.ScrollDownintoView(".//*[@id='winning-method-1']/div/div[1]/button");
	    PlexusSharedFunctions.ClickablebyXpath(".//*[@id='winning-method-1']/div/div[1]/button");
